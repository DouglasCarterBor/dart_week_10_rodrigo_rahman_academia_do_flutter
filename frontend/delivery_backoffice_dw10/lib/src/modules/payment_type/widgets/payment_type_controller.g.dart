...
mixin _$PaymentTypeController on PaymentTypeControllerBase, Store {
  ...
  late final _$_filterEnableAtom =
      Atom(name: 'PaymentTypeControllerBase._filterEnable', context: context);

  bool? get filterEnable {
    _$_filterEnableAtom.reportRead();
    return super._filterEnable;
  }

  @override
  bool? get _filterEnable => filterEnable;

  @override
  set _filterEnable(bool? value) {
    _$_filterEnableAtom.reportWrite(value, super._filterEnable, () {
      super._filterEnable = value;
    });
  }
  ...
  Future<void> savePayment(
    ...
    return _$savePaymentAsyncAction.run(() => super
        .savePayment(id: id, name: name, acronym: acronym, enable: enable));
  }
