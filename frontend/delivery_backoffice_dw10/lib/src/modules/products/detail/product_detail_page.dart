            ...
            child: Column(
              children: [
                Row(
                  children: [
                    Expanded(
                      child: Text('${widget.productId != null ? 'Alterar' : 'Cadastrar'} Produto',
                      ...
                      children: [
                        Observer(
                            builder: (_) {
                              ...
                              return Padding(
                                ...
                                child: Image.network('${Env.instance.get('backend_base_url')}${controller.imagePath}',
                                width: 200,
                                ),
                              ); 
                        ...
                        Container(
                          ...
                          child: TextButton(
                            ...
                            child: Text('${controller.imagePath == null ? 'Adicionar' : 'Alterar'}' ' Foto'),
                          ),
                ...
                TextFormField(
                  validator: Validatorless.required('Descrição obrigatória'),
                        ...
                        Container(
                          ...
                          child: Visibility(
                            ...
                            child: OutlinedButton(
                              ...
                              onPressed: (){
                                ...
                                builder: (context){                                  
                                  return AlertDialog(
                                    ...
                                    content: Text('Deseja realmente excluir o produto ${controller.productModel!.name}?'),
                                    actions: [
                                      TextButton(
                                        onPressed: (){
                                          Navigator.of(context).pop();                                          
                                        },
                                        child: Text('Cancelar', style: context.textStyles.textBold.copyWith(
                                          color: Colors.red,
                                        ),),                                        
                                      ),
                                      TextButton(
                              ...
                              child: Text('Deletar', style: context.textStyles.textBold.copyWith(
                                color: Colors.red,
                              ),),
                              ),
                          ),
                          ...
                          child: ElevatedButton(                        
                            onPressed: (){
                              ...
                              if(valid){
                                ...
                                controller.save(nameEC.text, UtilBrasilFields.converterMoedaParaDouble(priceEC.text), descriptionEC.text);
                              }
                            },
                            child: Text('Salvar', style: context.textStyles.textBold,
                            ),
                            ),
                        ), 
